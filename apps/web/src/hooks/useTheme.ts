...
const ThemePreference = Schema.Literals(["light", "dark", "system", "ucsd-light", "ucsd-dark"]);
...
function applyTheme(theme: Theme, suppressTransitions = false) {
  ...
  const isDark = theme === "dark" || theme === "ucsd-dark" || (theme === "system" && systemDark);
  if (root.dataset) {
