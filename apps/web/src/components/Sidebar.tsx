...
import { APP_INSTITUTION_NAME, APP_MARK_LABEL, APP_STAGE_LABEL, APP_VERSION } from "../branding";
...
function T3Wordmark() {
  return (
    <span
      aria-label={APP_MARK_LABEL}
      className="inline-flex h-6 items-center overflow-hidden rounded-md border border-border/80 bg-card shadow-sm"
      title={APP_INSTITUTION_NAME}
    >
      <span className="inline-flex h-full items-center bg-[var(--ucsd-navy)] px-2.5 text-[10px] font-semibold tracking-[0.24em] text-white">
        {APP_MARK_LABEL}
      </span>
      <span className="h-full w-1 bg-[var(--ucsd-yellow)]" />
    </span>
  );
}
