// This file mostly exists because we want dev mode to say "UCSD Code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "UCSD Code (Dev)" : "UCSD Code (Alpha)";
