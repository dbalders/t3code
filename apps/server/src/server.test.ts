    ...
    const servedRoutesLayer = HttpRouter.serve(makeRoutesLayer, {
      ...
      Layer.provide(
        Layer.mergeAll(
          Layer.mock(ProviderRegistry)({
            ...
            recordInstalledProviderSkill: () => Effect.succeed([]),
            recordRemovedProviderSkill: () => Effect.succeed([]),
      ...
      Layer.provide(
        Layer.mock(ServerSettingsService)({
          ...
          updateProviderSkillPreference: () => Effect.succeed(DEFAULT_SERVER_SETTINGS),
          streamChanges: Stream.empty,
    ...
    const appLayer = servedRoutesLayer.pipe(
      ...
      Layer.provide(
        Layer.mock(VcsProcess.VcsProcess)({
          run: () => Effect.die("VcsProcess not stubbed in this test"),
        }),
      ),
