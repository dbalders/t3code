...
engineLayer("OrchestrationProjectionPipeline via engine dispatch", (it) => {
  it.effect("marks an active turn errored when the session enters error state", () =>
    Effect.gen(function* () {
      ...
      const projectId = ProjectId.make("project-runtime-error");
      ...
      yield* engine.dispatch({
        type: "project.create",
        commandId: CommandId.make("cmd-runtime-error-project-created"),
        projectId,
      ...
      yield* engine.dispatch({
        type: "thread.create",
        commandId: CommandId.make("cmd-runtime-error-thread-created"),
        threadId,
        projectId,
      ...
      yield* engine.dispatch({
        type: "thread.session.set",
        commandId: CommandId.make("cmd-runtime-error-session-running"),
        threadId,
        createdAt: requestedAt,
        session: {
          threadId,
      ...
      yield* engine.dispatch({
        type: "thread.session.set",
        commandId: CommandId.make("cmd-runtime-error-session-errored"),
        threadId,
        createdAt: erroredAt,
        session: {
          threadId,
