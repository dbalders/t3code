...
Pod::Spec.new do |s|
  ...
  s.summary = 'Native terminal surface for TritonAI Harness mobile.'
  s.description = 'Native terminal surface bridge used by the TritonAI Harness React Native app.'
