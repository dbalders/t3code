  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new TritonGPT Code prerelease is available for nightly testers."
          : "A new TritonGPT Code latest release is available.",
...
).pipe(Command.withDescription("Post a TritonGPT Code release announcement to Discord."));
