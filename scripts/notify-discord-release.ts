  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new TritonAI Code prerelease is available for nightly testers."
          : "A new TritonAI Code latest release is available.",
...
).pipe(Command.withDescription("Post a TritonAI Code release announcement to Discord."));
